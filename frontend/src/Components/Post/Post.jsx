...
const Post=({postId,caption,postImage,postDate,likes=[],comments=[],ownerImage,ownerName,ownerId,isDelete=false,isAccount=false,})=> {
  ...
  return( <div className='post'>
      ...
      <span className="postDate">{format(postDate)}</span> 
      ...
      <button style={{
          ...
          cursor:"pointer",
          margin:"1vmax 2vmax",
      }}onClick={()=>setLikesUser(!likesUser)} disabled={likes.length===0?true:false}><Typography>{likes.length} likes</Typography></button>
